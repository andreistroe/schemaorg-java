...
public class DryCleaningOrLaundryImpl extends LocalBusinessImpl implements DryCleaningOrLaundry {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<DryCleaningOrLaundry.Builder>
    ...
    @Override
    public DryCleaningOrLaundry.Builder addImage(Thing value) {
