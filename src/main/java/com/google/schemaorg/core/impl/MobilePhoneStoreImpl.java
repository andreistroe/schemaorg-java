...
public class MobilePhoneStoreImpl extends StoreImpl implements MobilePhoneStore {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<MobilePhoneStore.Builder>
    ...
    @Override
    public MobilePhoneStore.Builder addImage(Thing value) {
