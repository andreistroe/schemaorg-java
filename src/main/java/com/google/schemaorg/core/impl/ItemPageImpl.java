...
public class ItemPageImpl extends WebPageImpl implements ItemPage {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<ItemPage.Builder>
    ...
    @Override
    public ItemPage.Builder addBreadcrumb(Thing value) {
    ...
    @Override
    public ItemPage.Builder addIsPartOf(Thing value) {
    ...
    @Override
    public ItemPage.Builder addPrimaryImageOfPage(Thing value) {
