...
public class InsuranceAgencyImpl extends FinancialServiceImpl implements InsuranceAgency {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<InsuranceAgency.Builder>
    ...
    @Override
    public InsuranceAgency.Builder addImage(Thing value) {
