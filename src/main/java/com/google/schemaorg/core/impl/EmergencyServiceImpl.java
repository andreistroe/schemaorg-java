...
public class EmergencyServiceImpl extends LocalBusinessImpl implements EmergencyService {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<EmergencyService.Builder>
    ...
    @Override
    public EmergencyService.Builder addImage(Thing value) {
