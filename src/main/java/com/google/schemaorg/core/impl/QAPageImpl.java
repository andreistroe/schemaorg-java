...
public class QAPageImpl extends WebPageImpl implements QAPage {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<QAPage.Builder>
    ...
    @Override
    public QAPage.Builder addBreadcrumb(Thing value) {
    ...
    @Override
    public QAPage.Builder addIsPartOf(Thing value) {
    ...
    @Override
    public QAPage.Builder addPrimaryImageOfPage(Thing value) {
