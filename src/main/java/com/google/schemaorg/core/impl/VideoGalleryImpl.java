...
public class VideoGalleryImpl extends CollectionPageImpl implements VideoGallery {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<VideoGallery.Builder>
    ...
    @Override
    public VideoGallery.Builder addBreadcrumb(Thing value) {
    ...
    @Override
    public VideoGallery.Builder addIsPartOf(Thing value) {
    ...
    @Override
    public VideoGallery.Builder addPrimaryImageOfPage(Thing value) {
