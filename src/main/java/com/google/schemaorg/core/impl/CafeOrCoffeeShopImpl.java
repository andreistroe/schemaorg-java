...
public class CafeOrCoffeeShopImpl extends FoodEstablishmentImpl implements CafeOrCoffeeShop {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<CafeOrCoffeeShop.Builder>
    ...
    @Override
    public CafeOrCoffeeShop.Builder addImage(Thing value) {
