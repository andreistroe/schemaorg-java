...
public class RecyclingCenterImpl extends LocalBusinessImpl implements RecyclingCenter {
  ...
  public static final class BuilderImpl extends SchemaOrgTypeImpl.BuilderImpl<RecyclingCenter.Builder>
    ...
    @Override
    public RecyclingCenter.Builder addImage(Thing value) {
